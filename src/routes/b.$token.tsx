        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label>Pickup</Label>
              <AddressAutocomplete value={from} onChange={(v) => { setFrom(v.address); setFromLocationType(classifyProviderEndpoint(v.place_types)); }} placeholder="Hotel, airport, address…" />
            </div>
            <div className="space-y-1.5">
              <Label>Drop-off</Label>
              <AddressAutocomplete value={to} onChange={(v) => { setTo(v.address); setToLocationType(classifyProviderEndpoint(v.place_types)); }} placeholder="Destination" />
            </div>
            <div className="space-y-1.5">
              <Label>Date</Label>
