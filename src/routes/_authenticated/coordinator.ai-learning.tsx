...
import { Sparkles, GraduationCap, Archive, Loader2 } from "lucide-react";
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2">
            <GraduationCap className="h-6 w-6 text-primary" /> AI learning
          </h1>
          <p className="text-sm text-muted-foreground">
            Teach the AI patterns your company sees a lot — hotel email formats, shorthand, how to handle a signal.
