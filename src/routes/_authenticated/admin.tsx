...
import { Building2, LogOut, Inbox, Activity, KeyRound, LifeBuoy, Globe, Plane } from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/flight-schedule", label: "Flight Schedule", icon: Plane, match: (p: string) => p.startsWith("/admin/flight-schedule") },
