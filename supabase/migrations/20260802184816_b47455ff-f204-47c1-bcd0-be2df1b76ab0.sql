...
ALTER TABLE public.companies DROP CONSTRAINT IF EXISTS companies_minimum_connection_buffer_minutes_check;
ALTER TABLE public.companies
  ADD CONSTRAINT companies_minimum_connection_buffer_minutes_check
  CHECK (minimum_connection_buffer_minutes BETWEEN 0 AND 1440);

ALTER TABLE public.jobs
  ADD COLUMN IF NOT EXISTS ship_event_id uuid REFERENCES public.ship_events(id) ON DELETE RESTRICT,
