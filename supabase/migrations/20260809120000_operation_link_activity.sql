...
CREATE TABLE public.operation_link_activity (
  ...
  action_type text NOT NULL CHECK (action_type IN ('eta_updated', 'departure_updated', 'port_change_requested', 'passenger_onboard_updated', 'operational_update_submitted')),
